...
function c2390019.ffilter(c,e,tp)
	return c:IsType(TYPE_FUSION) and c:IsRace(RACE_MACHINE) and c:IsAttribute(ATTRIBUTE_LIGHT) 
		and c.material and Duel.IsExistingMatchingCard(c2390019.cfilter,tp,LOCATION_HAND+LOCATION_MZONE,0,1,nil,c,e,tp)
end
...
function c2390019.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local rg=Duel.GetMatchingGroup(aux.NecroValleyFilter(c2390019.cfilter),tp,LOCATION_HAND+LOCATION_MZONE,0,nil)
