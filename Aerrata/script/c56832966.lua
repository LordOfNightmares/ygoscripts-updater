...
function c56832966.initial_effect(c)
	...
	e4:SetCondition(c56832966.atkcon2)
	c:RegisterEffect(e4)
end
c56832966.xyz_number=39
function c56832966.ndcfilter(c)
	return c:IsSetCard(0x48)
end
function c56832966.ndcfilter2(c)
	return not c:IsSetCard(0x48) 
end
function c56832966.ndcfilter3(c)
	return c:IsType(TYPE_TOKEN)
end 
function c56832966.atkcon2(e)
	if Duel.IsExistingMatchingCard(c56832966.ndcfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil) then
		return Duel.IsExistingMatchingCard(c56832966.ndcfilter2,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
	elseif Duel.IsExistingMatchingCard(c56832966.ndcfilter3,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil) then
		return Duel.IsExistingMatchingCard(c56832966.ndcfilter2,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
	end
end
