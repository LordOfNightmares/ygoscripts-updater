...
function c5008836.winfilter(e,c)
	return c:GetOwner()~=e:GetHandlerPlayer() and c:IsAttribute(ATTRIBUTE_DARK)
end
function c5008836.filter(c)
...
function c5008836.wincon(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=c:GetMaterial()
	return c:GetSummonType()==SUMMON_TYPE_ADVANCE+1 
	and g:Filter(c5008836.filter,nil) 
	and g:GetClassCount(Card.GetCode)==5
	and c5008836.winfilter(e,tc)
end
