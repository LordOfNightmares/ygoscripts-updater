...
function c26692769.initial_effect(c)
	--link summon
	aux.AddLinkProcedure(c,aux.FilterBoolFunction(Card.IsLinkAttribute,ATTRIBUTE_DARK),2,2,c26692769.lcheck)
	c:EnableReviveLimit()
	--to grave
...
function c26692769.lcheck(g,lc)
	return g:IsExists(Card.IsSetCard,1,nil,db)
end
