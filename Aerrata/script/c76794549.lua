function c76794549.initial_effect(c)
	...
	if not c76794549.global_check then
		...
		-- ge1:SetCondition(c76794549.ckeckcon)
		ge1:SetOperation(c76794549.checkop)
		Duel.RegisterEffect(ge1,0)
	end
end
function c76794549.ckeckcon(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c76794549.checkfilter,1,nil,tp)
end
function c76794549.checkfilter(c,tp)
	return c:IsSetCard(0xf8) or c:IsSetCard(0x98)
end
...
function c76794549.thfilter2(c,code)
	...
	and (c:IsSetCard(0xf8) or c:IsSetCard(0x98))
end
