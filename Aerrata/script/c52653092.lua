...
function c52653092.initial_effect(c)
	...
	e1:SetValue(c52653092.valcheck)
	c:RegisterEffect(e1)
...
function c52653092.valcheck(e,c)
	local rank=c:GetMaterial():GetFirst():GetRank()
	e:SetLabel(rank)
end
function c52653092.atkop(e,tp,eg,ep,ev,re,r,rp)
...
function c52653092.actop(e,tp,eg,ep,ev,re,r,rp)
	...
	e4:SetValue(c52653092.unval)
	e4:SetReset(RESET_PHASE+PHASE_END)
	-- c:RegisterEffect(e4)
	Duel.RegisterEffect(e4,c:GetControler())
end
function c52653092.unval(e,te)
