...
function c14799437.cfilter(c)
	return c:GetCode()~=14799437 and not c:IsStatus(STATUS_BATTLE_DESTROYED)
end
function c14799437.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c14799437.cfilter,2,nil) end
	local g=Duel.SelectReleaseGroup(tp,c14799437.cfilter,2,2,nil)
