...
function c10045474.initial_effect(c)
	...
	e2:SetCost(c10045474.handcost)
	e2:SetCondition(c10045474.handcon)
	c:RegisterEffect(e2)
end
function c10045474.cfilter(c)
	return c:IsDiscardable()
end
function c10045474.handcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsDiscardable()
		and Duel.IsExistingMatchingCard(c10045474.cfilter,tp,LOCATION_HAND,0,1,e:GetHandler()) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DISCARD)
	local g=Duel.SelectMatchingCard(tp,c10045474.cfilter,tp,LOCATION_HAND,0,1,1,e:GetHandler())
