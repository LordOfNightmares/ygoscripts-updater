function c25862681.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(51481927,0))
	e4:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e4:SetCode(EVENT_CHAIN_SOLVED)
	e4:SetRange(LOCATION_SZONE)
	e4:SetCondition(c25862681.condition)
	e4:SetOperation(c25862681.operation)
	c:RegisterEffect(e4)
end
...
function c25862681.condition(e,tp,eg,ep,ev,re,r,rp)
	return re 
...
function c25862681.operation(e,tp,eg,ep,ev,re,r,rp)
