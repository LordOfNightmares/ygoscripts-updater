...
function c30539496.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(g1,REASON_EFFECT)==2 then
		...
		local rg=Duel.GetMatchingGroup(Card.IsCanBeEffectTarget,tp,0,LOCATION_EXTRA,nil)
